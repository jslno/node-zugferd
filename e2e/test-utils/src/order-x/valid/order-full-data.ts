...
export const orderFullData: typeof orderX.$Infer.Input = {
	processControl: {
		testIndicator: false,
		businessContextInfo: {
			processType: "A1",
	...
	transaction: {
		...
		contract: {
			...
			additionalReferencedDocuments: [
				...
				{
					issuerAssignedId: "TENDER_ID",
					typeCode: "50",
				},
				{
					issuerAssignedId: "OBJECT_ID",
					typeCode: "130",
					referenceTypeCode: "AWV",
				},
			],
			catalogueReference: {
				issuerAssignedId: "CATALOG_ID",
			},
			blanketOrderReference: {
		...
		debit: {
			...
			invoicee: {
				...
				organization: {
					...
					tradingName: "INVOICEE_TRADING_NAME",
				},
				contact: [
					{
						personName: "INVOICEE_CONTACT_NAME",
						departmentName: "INVOICEE_CONTACT_DEP",
						typeCode: "LB",
						phoneNumber: "+33 6 65 98 75 32",
						emailAddress: "invoicee@buyer.com",
					},
				],
				postalAddress: {
					postCode: "69001",
					line1: "INVOICEE_ADDR_1",
					line2: "INVOICEE_ADDR_2",
					line3: "INVOICEE_ADDR_3",
					city: "INVOICEE_CITY",
					countryCode: "FR",
				},
				electronicAddress: {
					value: "invoicee@buyer.com",
					schemeId: "EM",
				},
				taxRegistration: {
					vat: [
