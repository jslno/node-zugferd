...
export const subInvoiceLineOfficeSuppliesData: typeof invoicer.$Infer.Input.Extended =
	{
		exchangedDocument: {
			invoiceNumber: "99877",
			invoiceTypeCode: "380",
		...
		transaction: {
			line: [
				...
				},
				{
					...
					item: {
						...
						buyerAssignedId: "88888876543219",
						name: "Allowance",
						description: "Abschlagsposition 10% von 450.-",
					},
					priceDetails: {
						netPrice: {
							chargeAmount: 45,
			...
			debit: {
				...
				paymentTerms: [
					{
						description:
							"Bei Zahlung bis zum 06.06.2026 zahlen Sie mit 2,00 % Skonto € 1638,51 €",
				...
				documentTotals: {
					lineTotalAmount: 1405,
					chargeTotalAmount: 0,
					allowanceTotalAmount: 0,
					taxBasisTotalAmount: 1405,
					taxTotalAmount: {
						value: 266.95,
						currency: "EUR",
					},
					grandTotalAmount: 1671.95,
					prepaidAmount: 0,
					duePayableAmount: 1671.95,
				},
				accounting: {
