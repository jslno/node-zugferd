...
export const discountsData: typeof invoicer.$Infer.Input.En16931 = {
	exchangedDocument: {
	...
	transaction: {
		...
		debit: {
			...
			documentTotals: {
				lineTotalAmount: 202.7,
				chargeTotalAmount: 5.8,
				allowanceTotalAmount: 14.73,
				taxBasisTotalAmount: 193.77,
				taxTotalAmount: {
					value: 21.3,
					currency: "EUR",
				},
				grandTotalAmount: 215.07,
				prepaidAmount: 50,
				duePayableAmount: 165.07,
			},
		},
	},
};
