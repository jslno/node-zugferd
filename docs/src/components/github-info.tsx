...
export async function GithubInfo({
	...
	return (
		<a
			...
			{...props}
			className={cn(
				"flex flex-col gap-1.5 py-2 px-4 rounded-lg text-sm no-underline not-prose border text-fd-foreground/80 transition-colors lg:flex-row lg:items-center hover:text-fd-accent-foreground hover:bg-fd-accent",
				props.className,
			)}
		>
