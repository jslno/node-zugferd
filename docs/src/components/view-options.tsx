...
export const ViewOptions = (props: ViewOptionsProps) => {
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			...
			<PopoverContent className="flex flex-col p-1 overflow-auto w-fit">
				{[
					{
					...
					<a
						...
						target="_blank"
						className="text-sm p-2 rounded-lg inline-flex items-center gap-2 hover:text-accent-foreground focus-visible:text-accent-foreground hover:bg-accent focus-visible:bg-accent transition-colors [&_svg]:size-4"
					>
						{item.icon}
						{item.title}
