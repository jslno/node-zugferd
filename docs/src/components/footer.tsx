...
export const Footer = ({className, ...props }: React.ComponentPropsWithoutRef<"footer">) => {
  return (
    <footer className={cn("py-2 md:h-[58px] flex items-center gap-4 px-5 border-t w-full", className)} {...props}>
