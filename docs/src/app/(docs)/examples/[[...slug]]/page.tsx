...
import { examplesSource, getPageImage, getPageMarkdownUrl } from "@/lib/source";
...
export default async function Page(props: PageProps<"/examples/[[...slug]]">) {
	...
	const markdownUrl = getPageMarkdownUrl(page, "examples").url;

	const gitPath = `docs/content/examples/${page.path}`;
...
export async function generateMetadata(
	...
	return {
		...
		openGraph: {
			images: getPageImage(page, "examples").url,
		},
	};
}
