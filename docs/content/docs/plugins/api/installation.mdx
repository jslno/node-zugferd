---
title: Installation
description: Learn how to configure the API plugin in your project.
---
...
Continue to [basic usage](/docs/plugins/api/basic-usage) to learn how to use the API Plugin to generate invoices.
