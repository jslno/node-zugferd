...
<Callout type="warn">
This guide assumes you have [setup the basics](/docs/basic-usage) of node-zugferd and are ready to create your first profile.
</Callout>
...
```ts title="schema.ts"
import type { Schema } from "node-zugferd/profile";
