...
<Step>
  ...
  invoice, and learned how to save it as a PDF/A-3b file or XML. You can
  now automate the generation of invoices with structured data in the format that fits your needs.
</Step>
