...
const source = path.resolve(__dirname, "./codelist/allowance/output.xml");

export const allowance = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/allowance",
