...
const source = path.resolve(__dirname, "./codelist/untdid-1153/output.xml");

export const untdid1153 = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/untdid-1153",
