...
const source = path.resolve(__dirname, "./codelist/line-reason/output.xml");

export const lineReason = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/line-reason",
