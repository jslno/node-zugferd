...
const source = path.resolve(__dirname, "./codelist/incoterms/output.xml");

export const incoterms = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/incoterms",
