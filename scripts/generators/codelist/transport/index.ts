...
const source = path.resolve(__dirname, "./codelist/transport/output.xml");

export const transport = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/transport",
