...
const source = path.resolve(__dirname, "./codelist/line-status/output.xml");

export const lineStatus = defineParser(async (ctx) => {
	...
	return {
		packageRoot: "./packages/codelists/line-status",
