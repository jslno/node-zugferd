...
\t},`;
  ...
  await fs.writeFile(
    "./packages/node-zugferd/src/codelists/generated/untdid.7143.ts",
...
/**
 * Generated by ${"`"}scripts/untdid.7143.js${"`"} on ${new Date().toUTCString()}
 * 
 * @see https://www.xrepository.de/details/urn:xoev-de:kosit:codeliste:untdid.7143
 */
export const UNTDID_7143 = [${mappedData.join("")}${
      mappedData.length > 0 ? "\n" : ""
