...
\t},`;
  ...
  await fs.writeFile(
    "./packages/node-zugferd/src/codelists/generated/untdid.5189.ts",
...
/**
 * Generated by ${"`"}scripts/untdid.5189.js${"`"} on ${new Date().toUTCString()}
 * 
 * @see https://www.xrepository.de/details/urn:xoev-de:kosit:codeliste:untdid.5189
 */
export const UNTDID_5189 = [${mappedData.join("")}${
      mappedData.length > 0 ? "\n" : ""
