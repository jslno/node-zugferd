...
\t},`;
  ...
  await fs.writeFile(
    "./packages/node-zugferd/src/codelists/generated/untdid.4451.ts",
...
/**
 * Generated by ${"`"}scripts/untdid.4451.js${"`"} on ${new Date().toUTCString()}
 * 
 * @see https://www.xrepository.de/details/urn:xoev-de:kosit:codeliste:untdid.4451
 */
export const UNTDID_4451 = [${mappedData.join("")}${
      mappedData.length > 0 ? "\n" : ""
