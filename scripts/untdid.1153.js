...
\t},`;
  ...
  await fs.writeFile(
    "./packages/node-zugferd/src/codelists/generated/untdid.1153.ts",
...
/**
 * Generated by ${"`"}scripts/untdid.1153.js${"`"} on ${new Date().toUTCString()}
 * 
 * @see https://www.xrepository.de/details/urn:xoev-de:kosit:codeliste:untdid.1153
 */
export const UNTDID_1153 = [${mappedData.join("")}${
      mappedData.length > 0 ? "\n" : ""
