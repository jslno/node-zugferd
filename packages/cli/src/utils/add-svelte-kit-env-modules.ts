export const addSvelteKitEnvModules = (aliases: Record<string, string>) => {
...
const createDataUriModule = (module: string) => {
	return `data:text/javascript;charset=utf-8,${encodeURIComponent(module)}`;
};

const createStaticEnvModule = (env: Record<string, string>) => {
