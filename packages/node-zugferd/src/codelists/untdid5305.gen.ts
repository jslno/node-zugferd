 ...
 *
 * @see {@link https://github.com/jslno/node-zugferd/blob/main/packages/node-zugferd/scripts/codelists/untdid5305/output.xml|Source}
 */

import type Script from "../../scripts/codelists/untdid-5305/index.js";
...
export type Untdid5305Code = (typeof UNTDID5305)[number]["value"];
...
export const untdid5305Code = UNTDID5305.map(({ value }) => value);

export const Untdid5305 = createEnum(UNTDID5305, {
	keyProp: "key",
	valueProp: "value",
});
