 ...
 *
 * @see {@link https://github.com/jslno/node-zugferd/blob/main/packages/node-zugferd/scripts/codelists/eas/output.xml|Source}
 */

import type Script from "../../scripts/codelists/eas/index.ts";
...
export type EasCode = (typeof EAS)[number]["value"];

export const PUBLISHED = "14" as const;
...
export const easCode = EAS.map(({ value }) => value);
