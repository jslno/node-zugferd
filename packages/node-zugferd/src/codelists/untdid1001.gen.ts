 ...
 *
 * @see {@link https://github.com/jslno/node-zugferd/blob/main/packages/node-zugferd/scripts/codelists/untdid1001/output.xml|Source}
 */

import type Script from "../../scripts/codelists/untdid-1001/index.js";
...
export type Untdid1001Code = (typeof UNTDID1001)[number]["value"];

export const PUBLISHED = new Date("2025-01-01T00:00:00.000Z");
...
export const untdid1001Code = UNTDID1001.map(({ value }) => value);

export const Untdid1001 = createEnum(UNTDID1001, {
	keyProp: "key",
	valueProp: "value",
});
