/**
 * Generated by `scripts/rec21/update.js` on Mon, 28 Jul 2025 10:40:52 GMT
 *
...
export const REC21 = [
	{ code: "X1A", name: "Drum, steel", description: undefined },
	{ code: "X1B", name: "Drum, aluminium", description: undefined },
	{ code: "X1D", name: "Drum, plywood", description: undefined },
	{
		code: "X1F",
		name: "Container, flexible",
		description: "A packaging container of flexible construction.",
	},
	{ code: "X1G", name: "Drum, fibre", description: undefined },
	{ code: "X1W", name: "Drum, wooden", description: undefined },
	{ code: "X2C", name: "Barrel, wooden", description: undefined },
	{ code: "X3A", name: "Jerrican, steel", description: undefined },
	{ code: "X3H", name: "Jerrican, plastic", description: undefined },
	{
		code: "X43",
		name: "Bag, super bulk",
		description:
	...
	{ code: "X4A", name: "Box, steel", description: undefined },
	{ code: "X4B", name: "Box, aluminium", description: undefined },
	{ code: "X4C", name: "Box, natural wood", description: undefined },
	{ code: "X4D", name: "Box, plywood", description: undefined },
	{ code: "X4F", name: "Box, reconstituted wood", description: undefined },
	{ code: "X4G", name: "Box, fibreboard", description: undefined },
	{ code: "X4H", name: "Box, plastic", description: undefined },
	{ code: "X5H", name: "Bag, woven plastic", description: undefined },
	{ code: "X5L", name: "Bag, textile", description: undefined },
	{ code: "X5M", name: "Bag, paper", description: undefined },
	{
		code: "X6H",
	...
	{ code: "XAE", name: "Aerosol", description: undefined },
	{
		code: "XAF",
	...
	{ code: "XAI", name: "Clamshell", description: undefined },
	{
		code: "XAJ",
		name: "Cone",
		description:
	...
	{ code: "XAM", name: "Ampoule, non-protected", description: undefined },
	{ code: "XAP", name: "Ampoule, protected", description: undefined },
	{ code: "XAT", name: "Atomizer", description: undefined },
	{ code: "XAV", name: "Capsule", description: undefined },
	{
		code: "XB4",
		name: "Belt",
		description: "A band use to retain multiple articles together.",
	},
	{ code: "XBA", name: "Barrel", description: undefined },
	{ code: "XBB", name: "Bobbin", description: undefined },
	{ code: "XBC", name: "Bottlecrate / bottlerack", description: undefined },
	{ code: "XBD", name: "Board", description: undefined },
	{ code: "XBE", name: "Bundle", description: undefined },
	{ code: "XBF", name: "Balloon, non-protected", description: undefined },
	{
		code: "XBG",
		name: "Bag",
		description:
	...
	{ code: "XBH", name: "Bunch", description: undefined },
	{ code: "XBI", name: "Bin", description: undefined },
	{ code: "XBJ", name: "Bucket", description: undefined },
	{ code: "XBK", name: "Basket", description: undefined },
	{ code: "XBL", name: "Bale, compressed", description: undefined },
	{ code: "XBM", name: "Basin", description: undefined },
	{ code: "XBN", name: "Bale, non-compressed", description: undefined },
	{
		code: "XBO",
	...
	{ code: "XBP", name: "Balloon, protected", description: undefined },
	{
		code: "XBQ",
	...
	{ code: "XBR", name: "Bar", description: undefined },
	{
		code: "XBS",
	...
	{ code: "XBT", name: "Bolt", description: undefined },
	{ code: "XBU", name: "Butt", description: undefined },
	{
		code: "XBV",
	...
	{ code: "XBW", name: "Box, for liquids", description: undefined },
	{ code: "XBX", name: "Box", description: undefined },
	{ code: "XBY", name: "Board, in bundle/bunch/truss", description: undefined },
	{ code: "XBZ", name: "Bars, in bundle/bunch/truss", description: undefined },
	{ code: "XCA", name: "Can, rectangular", description: undefined },
	{ code: "XCB", name: "Crate, beer", description: undefined },
	{ code: "XCC", name: "Churn", description: undefined },
	{ code: "XCD", name: "Can, with handle and spout", description: undefined },
	{ code: "XCE", name: "Creel", description: undefined },
	{ code: "XCF", name: "Coffer", description: undefined },
	{ code: "XCG", name: "Cage", description: undefined },
	{ code: "XCH", name: "Chest", description: undefined },
	{ code: "XCI", name: "Canister", description: undefined },
	{ code: "XCJ", name: "Coffin", description: undefined },
	{ code: "XCK", name: "Cask", description: undefined },
	{ code: "XCL", name: "Coil", description: undefined },
	{
		code: "XCM",
		name: "Card",
		description:
	...
	{ code: "XCO", name: "Carboy, non-protected", description: undefined },
	{ code: "XCP", name: "Carboy, protected", description: undefined },
	{
		code: "XCQ",
		name: "Cartridge",
		description:
	...
	{ code: "XCR", name: "Crate", description: undefined },
	{ code: "XCS", name: "Case", description: undefined },
	{ code: "XCT", name: "Carton", description: undefined },
	{ code: "XCU", name: "Cup", description: undefined },
	{ code: "XCV", name: "Cover", description: undefined },
	{ code: "XCW", name: "Cage, roll", description: undefined },
	{ code: "XCX", name: "Can, cylindrical", description: undefined },
	{ code: "XCY", name: "Cylinder", description: undefined },
	{ code: "XCZ", name: "Canvas", description: undefined },
	{
		code: "XDA",
	...
	{ code: "XDI", name: "Drum, iron", description: undefined },
	{ code: "XDJ", name: "Demijohn, non-protected", description: undefined },
	{ code: "XDK", name: "Crate, bulk, cardboard", description: undefined },
	{ code: "XDL", name: "Crate, bulk, plastic", description: undefined },
	{ code: "XDM", name: "Crate, bulk, wooden", description: undefined },
	{ code: "XDN", name: "Dispenser", description: undefined },
	{ code: "XDP", name: "Demijohn, protected", description: undefined },
	{ code: "XDR", name: "Drum", description: undefined },
	{
		code: "XDS",
	...
	{ code: "XEC", name: "Bag, plastic", description: undefined },
	{ code: "XED", name: "Case, with pallet base", description: undefined },
	{
		code: "XEE",
	...
	{ code: "XEI", name: "Case, isothermic", description: undefined },
	{ code: "XEN", name: "Envelope", description: undefined },
	{
		code: "XFB",
		name: "Flexibag",
		description:
	...
	{ code: "XFC", name: "Crate, fruit", description: undefined },
	{ code: "XFD", name: "Crate, framed", description: undefined },
	{
		code: "XFE",
		name: "Flexitank",
		description:
	...
	{ code: "XFI", name: "Firkin", description: undefined },
	{ code: "XFL", name: "Flask", description: undefined },
	{ code: "XFO", name: "Footlocker", description: undefined },
	{ code: "XFP", name: "Filmpack", description: undefined },
	{ code: "XFR", name: "Frame", description: undefined },
	{ code: "XFT", name: "Foodtainer", description: undefined },
	{
		code: "XFW",
		name: "Cart, flatbed",
		description:
	...
	{ code: "XFX", name: "Bag, flexible container", description: undefined },
	{
		code: "XGB",
		name: "Bottle, gas",
		description:
	...
	{ code: "XGI", name: "Girder", description: undefined },
	{
		code: "XGL",
	...
	{ code: "XHA", name: "Basket, with handle, plastic", description: undefined },
	{ code: "XHB", name: "Basket, with handle, wooden", description: undefined },
	{
		code: "XHC",
		name: "Basket, with handle, cardboard",
		description: undefined,
	},
	{ code: "XHG", name: "Hogshead", description: undefined },
	{
		code: "XHN",
		name: "Hanger",
		description:
	...
	{ code: "XHR", name: "Hamper", description: undefined },
	{ code: "XIA", name: "Package, display, wooden", description: undefined },
	{ code: "XIB", name: "Package, display, cardboard", description: undefined },
	{ code: "XIC", name: "Package, display, plastic", description: undefined },
	{ code: "XID", name: "Package, display, metal", description: undefined },
	{ code: "XIE", name: "Package, show", description: undefined },
	{
		code: "XIF",
		name: "Package, flow",
		description:
	...
	{ code: "XIG", name: "Package, paper wrapped", description: undefined },
	{ code: "XIH", name: "Drum, plastic", description: undefined },
	{
		code: "XIK",
	...
	{ code: "XIN", name: "Ingot", description: undefined },
	{
		code: "XIZ",
	...
	{ code: "XJC", name: "Jerrican, rectangular", description: undefined },
	{ code: "XJG", name: "Jug", description: undefined },
	{ code: "XJR", name: "Jar", description: undefined },
	{ code: "XJT", name: "Jutebag", description: undefined },
	{ code: "XJY", name: "Jerrican, cylindrical", description: undefined },
	{ code: "XKG", name: "Keg", description: undefined },
	{
		code: "XKI",
		name: "Kit",
	...
	{ code: "XLG", name: "Log", description: undefined },
	{ code: "XLT", name: "Lot", description: undefined },
	{
		code: "XLU",
		name: "Lug",
		description:
	...
	{ code: "XLZ", name: "Logs, in bundle/bunch/truss", description: undefined },
	{
		code: "XMA",
		name: "Crate, metal",
		description:
	...
	{ code: "XMB", name: "Bag, multiply", description: undefined },
	{ code: "XMC", name: "Crate, milk", description: undefined },
	{
		code: "XME",
	...
	{ code: "XMS", name: "Sack, multi-wall", description: undefined },
	{ code: "XMT", name: "Mat", description: undefined },
	{
		code: "XMW",
	...
	{ code: "XMX", name: "Matchbox", description: undefined },
	{ code: "XNA", name: "Not available", description: undefined },
	{ code: "XNE", name: "Unpacked or unpackaged", description: undefined },
	{
		code: "XNF",
	...
	{ code: "XNS", name: "Nest", description: undefined },
	{ code: "XNT", name: "Net", description: undefined },
	{ code: "XNU", name: "Net, tube, plastic", description: undefined },
	{ code: "XNV", name: "Net, tube, textile", description: undefined },
	{
		code: "XOA",
	...
	{ code: "XPA", name: "Packet", description: "Small package." },
	{
		code: "XPB",
		name: "Pallet, box Combined open-ended box and pallet",
		description: undefined,
	},
	{ code: "XPC", name: "Parcel", description: undefined },
	{
		code: "XPD",
	...
	{ code: "XPG", name: "Plate", description: undefined },
	{ code: "XPH", name: "Pitcher", description: undefined },
	{ code: "XPI", name: "Pipe", description: undefined },
	{ code: "XPJ", name: "Punnet", description: undefined },
	{ code: "XPK", name: "Package", description: "Standard packaging unit." },
	{ code: "XPL", name: "Pail", description: undefined },
	{ code: "XPN", name: "Plank", description: undefined },
	{ code: "XPO", name: "Pouch", description: undefined },
	{ code: "XPP", name: "Piece", description: "A loose or unpacked article." },
	{
		code: "XPR",
	...
	{ code: "XPT", name: "Pot", description: undefined },
	{ code: "XPU", name: "Tray", description: undefined },
	{ code: "XPV", name: "Pipes, in bundle/bunch/truss", description: undefined },
	{
		code: "XPX",
		name: "Pallet",
		description:
	...
	{ code: "XQB", name: "Drum, steel, removable head", description: undefined },
	{
		code: "XQC",
	...
	{ code: "XQH", name: "Barrel, wooden, bung type", description: undefined },
	{
		code: "XQJ",
	...
	{ code: "XQR", name: "Box, plastic, expanded", description: undefined },
	{ code: "XQS", name: "Box, plastic, solid", description: undefined },
	{ code: "XRD", name: "Rod", description: undefined },
	{ code: "XRG", name: "Ring", description: undefined },
	{ code: "XRJ", name: "Rack, clothing hanger", description: undefined },
	{ code: "XRK", name: "Rack", description: undefined },
	{
		code: "XRL",
		name: "Reel",
		description:
	...
	{ code: "XRO", name: "Roll", description: undefined },
	{
		code: "XRT",
		name: "Rednet",
		description:
	...
	{ code: "XRZ", name: "Rods, in bundle/bunch/truss", description: undefined },
	{ code: "XSA", name: "Sack", description: undefined },
	{ code: "XSB", name: "Slab", description: undefined },
	{ code: "XSC", name: "Crate, shallow", description: undefined },
	{ code: "XSD", name: "Spindle", description: undefined },
	{ code: "XSE", name: "Sea-chest", description: undefined },
	{ code: "XSH", name: "Sachet", description: undefined },
	{
		code: "XSI",
		name: "Skid",
		description:
	...
	{ code: "XSK", name: "Case, skeleton", description: undefined },
	{
		code: "XSL",
		name: "Slipsheet",
		description:
	...
	{ code: "XSM", name: "Sheetmetal", description: undefined },
	{
		code: "XSO",
		name: "Spool",
		description:
	...
	{ code: "XSP", name: "Sheet, plastic wrapping", description: undefined },
	{ code: "XSS", name: "Case, steel", description: undefined },
	{ code: "XST", name: "Sheet", description: undefined },
	{ code: "XSU", name: "Suitcase", description: undefined },
	{ code: "XSV", name: "Envelope, steel", description: undefined },
	{
		code: "XSW",
		name: "Shrinkwrapped",
		description:
	...
	{ code: "XSY", name: "Sleeve", description: undefined },
	{
		code: "XSZ",
	...
	{ code: "XTB", name: "Tub", description: undefined },
	{ code: "XTC", name: "Tea-chest", description: undefined },
	{ code: "XTD", name: "Tube, collapsible", description: undefined },
	{
		code: "XTE",
		name: "Tyre",
	...
	{ code: "XTI", name: "Tierce", description: undefined },
	{ code: "XTK", name: "Tank, rectangular", description: undefined },
	{ code: "XTL", name: "Tub, with lid", description: undefined },
	{ code: "XTN", name: "Tin", description: undefined },
	{ code: "XTO", name: "Tun", description: undefined },
	{ code: "XTR", name: "Trunk", description: undefined },
	{ code: "XTS", name: "Truss", description: undefined },
	{ code: "XTT", name: "Bag, tote", description: "A capacious bag or basket." },
	{ code: "XTU", name: "Tube", description: undefined },
	{
		code: "XTV",
	...
	{ code: "XTY", name: "Tank, cylindrical", description: undefined },
	{ code: "XTZ", name: "Tubes, in bundle/bunch/truss", description: undefined },
	{ code: "XUC", name: "Uncaged", description: undefined },
	{
		code: "XUN",
		name: "Unit",
		description:
	...
	{ code: "XVA", name: "Vat", description: undefined },
	{
		code: "XVG",
		name: "Bulk, gas (at 1031 mbar and 15°C)",
		description: undefined,
	},
	{ code: "XVI", name: "Vial", description: undefined },
	{ code: "XVK", name: "Vanpack", description: "A type of wooden crate." },
	{ code: "XVL", name: "Bulk, liquid", description: undefined },
	{
		code: "XVO",
		name: "Bulk, solid, large particles (“nodules”)",
		description: undefined,
	},
	{ code: "XVP", name: "Vacuum-packed", description: undefined },
	{
		code: "XVQ",
	...
	{ code: "XWB", name: "Wickerbottle", description: undefined },
	{
		code: "XWC",
	...
	{ code: "XXD", name: "Bag, plastics film", description: undefined },
	{
		code: "XXF",
		name: "Bag, textile, without inner coat/liner",
		description: undefined,
	},
	{ code: "XXG", name: "Bag, textile, sift proof", description: undefined },
	{
		code: "XXH",
		name: "Bag, textile, water resistant",
		description: undefined,
	},
	{ code: "XXJ", name: "Bag, paper, multi-wall", description: undefined },
	{
		code: "XXK",
	...
	{ code: "XZB", name: "Bag, large", description: undefined },
	{
		code: "XZC",
	...
	{ code: "XZZ", name: "Mutually defined", description: undefined },
