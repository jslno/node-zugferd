 ...
 *
 * @see {@link https://github.com/jslno/node-zugferd/blob/main/packages/node-zugferd/scripts/codelists/item/output.xml|Source}
 */

import type Script from "../../scripts/codelists/item/index.ts";
...
export type ItemCode = (typeof ITEM)[number]["value"];
...
export const ITEM = [
	...
	{
		key: "UPC_UNIVERSAL_PRODUCT_CODEEAN_EUROPEAN_ARTICLE_NUMBER",
...
export const itemCode = ITEM.map(({ value }) => value);

export const Item = createEnum(ITEM, {
	keyProp: "key",
	valueProp: "value",
});
