...
import type Script from "../../scripts/codelists/untdid-1001/index.ts";
...
export type Untdid1001Code = (typeof UNTDID_1001)[number]["value"];
...
export const untdid1001Code = UNTDID_1001.map(({ value }) => value);
