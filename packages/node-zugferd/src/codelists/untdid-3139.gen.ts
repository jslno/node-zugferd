...
import type Script from "../../scripts/codelists/untdid-3139/index.ts";
...
export type Untdid3139Code = (typeof UNTDID_3139)[number]["value"];
...
export const untdid3139Code = UNTDID_3139.map(({ value }) => value);
