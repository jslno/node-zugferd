...
import type Script from "../../scripts/codelists/charge/index.ts";
...
export type ChargeCode = (typeof CHARGE)[number]["value"];
...
export const chargeCode = CHARGE.map(({ value }) => value);

export const Charge = createEnum(CHARGE, {
	keyProp: "key",
	valueProp: "value",
});
