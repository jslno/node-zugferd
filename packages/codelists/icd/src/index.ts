 ...
 * To update the codelist, edit the generator script at scripts/codelists/icd/index.ts
...
export const icd = [
	...
	{ key: "NBS_OSI_NETWORK", name: "NBS/OSI NETWORK", value: "0004" },
	{
	...
	{ key: "SNA_OSI_NETWORK", name: "SNA/OSI Network", value: "0018" },
	{
	...
	{ key: "ATT_OSI_NETWORK", name: "AT&T/OSI Network", value: "0030" },
	{
	...
	{ key: "NAVISTAR_OSI_NETWORK", name: "NAVISTAR/OSI Network", value: "0072" },
	{
	...
	{ key: "MCI_OSI_NETWORK", name: "MCI / OSI Network", value: "0119" },
	...
	{ key: "GTE_OSI_NETWORK", name: "GTE/OSI Network", value: "0126" },
	{
	...
	{
		key: "PLATEFORMES_AGREEES_A_LA_FACTURATION_ELECTRONIQUE_PPF_PDP",
...
export type Icd = {
	[K in (typeof icd)[number] as K["key"]]: K["value"];
};

export const Icd = Object.fromEntries(
	icd.map((item) => [item.key, item.value]),
) as Icd;
