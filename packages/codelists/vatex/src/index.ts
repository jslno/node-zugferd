 ...
 * To update the codelist, edit the generator script at scripts/codelists/vatex/index.ts
...
export type Vatex = {
	[K in (typeof vatex)[number] as K["key"]]: K["value"];
};

export const Vatex = Object.fromEntries(
	vatex.map((item) => [item.key, item.value]),
) as Vatex;
