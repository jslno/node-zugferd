 ...
 * To update the codelist, edit the generator script at scripts/codelists/language/index.ts
...
export type Language = {
	[K in (typeof language)[number] as K["key"]]: K["value"];
};

export const Language = Object.fromEntries(
	language.map((item) => [item.key, item.value]),
) as Language;
