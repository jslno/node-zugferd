 ...
 * To update the codelist, edit the generator script at scripts/codelists/currency/index.ts
...
export type Currency = {
	[K in (typeof currency)[number] as K["key"]]: K["value"];
};

export const Currency = Object.fromEntries(
	currency.map((item) => [item.key, item.value]),
) as Currency;
