 ...
 * To update the codelist, edit the generator script at scripts/codelists/payment/index.ts
...
export type Payment = {
	[K in (typeof payment)[number] as K["key"]]: K["value"];
};

export const Payment = Object.fromEntries(
	payment.map((item) => [item.key, item.value]),
) as Payment;
