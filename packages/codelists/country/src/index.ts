 ...
 * To update the codelist, edit the generator script at scripts/codelists/country/index.ts
...
export type Country = {
	[K in (typeof country)[number] as K["key"]]: K["value"];
};

export const Country = Object.fromEntries(
	country.map((item) => [item.key, item.value]),
) as Country;
