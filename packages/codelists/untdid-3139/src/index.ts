 ...
 * To update the codelist, edit the generator script at scripts/codelists/untdid-3139/index.ts
...
export type Untdid3139 = {
	[K in (typeof untdid3139)[number] as K["key"]]: K["value"];
};

export const Untdid3139 = Object.fromEntries(
	untdid3139.map((item) => [item.key, item.value]),
) as Untdid3139;
