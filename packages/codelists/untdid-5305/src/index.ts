 ...
 * To update the codelist, edit the generator script at scripts/codelists/untdid-5305/index.ts
...
export type Untdid5305 = {
	[K in (typeof untdid5305)[number] as K["key"]]: K["value"];
};

export const Untdid5305 = Object.fromEntries(
	untdid5305.map((item) => [item.key, item.value]),
) as Untdid5305;
