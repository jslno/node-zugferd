 ...
 * To update the codelist, edit the generator script at scripts/codelists/text/index.ts
...
export type Text = {
	[K in (typeof text)[number] as K["key"]]: K["value"];
};

export const Text = Object.fromEntries(
	text.map((item) => [item.key, item.value]),
) as Text;
