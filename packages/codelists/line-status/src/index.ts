 ...
 * To update the codelist, edit the generator script at scripts/codelists/line-status/index.ts
...
export type LineStatus = {
	[K in (typeof lineStatus)[number] as K["key"]]: K["value"];
};

export const LineStatus = Object.fromEntries(
	lineStatus.map((item) => [item.key, item.value]),
) as LineStatus;
