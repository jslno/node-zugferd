 ...
 * To update the codelist, edit the generator script at scripts/codelists/unit/index.ts
...
export type Unit = {
	[K in (typeof unit)[number] as K["key"]]: K["value"];
};

export const Unit = Object.fromEntries(
	unit.map((item) => [item.key, item.value]),
) as Unit;
